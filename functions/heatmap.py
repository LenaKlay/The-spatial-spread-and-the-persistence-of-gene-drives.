...
def heatmap(bio_para, num_para, graph_para, rlog, precision, x, y):
    ...
    # Save final data
    save_fig_or_data(save_loc, [], heatmap_values, "y_line_all", bio_para, num_para)
...
def load_heatmap(bio_para, rlog, precision, migale, x, y) :
    ...
    if migale :
        ...
        save_fig_or_data(save_loc, [], speed_values, "1_speed", bio_para, None)
        save_fig_or_data(save_loc, [], coex_values, "1_coex", bio_para, None)
